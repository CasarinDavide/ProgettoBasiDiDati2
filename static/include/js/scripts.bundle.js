...
var KTApp = function () {
    ...
    var createDateRangePickers = function() {
        ...
        elements.map(function (element) {
            ...
            $(element).daterangepicker({
                ...
                'Prossimi 30 gg': [moment(), moment().add(29, 'days')],
                'Mese Corrente': [moment().startOf('month'), moment().endOf('month')],
                'Mese Prec.': [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')],
    ...
    var createSelect2 = function () {
        ...
        elements.map(function (element) {
            ...
            if (element.getAttribute('data-allow-clear') == 'true') {
                options.allowClear = true;
            }
            if (element.getAttribute('data-search-type') == 'mac') {
                options.matcher = function(params, data) {
                   ...
                   if(data.text.toLowerCase().replaceAll(':','').indexOf(params.term) > -1 ||
                       data.text.toLowerCase().indexOf(params.term) > -1
                   ) {
            ...
            if (element.getAttribute('data-select2-template') != null) {
                options.templateSelection = window[element.getAttribute('data-select2-template')];
                options.templateResult = window[element.getAttribute('data-select2-template')];
            }
...
// ################### CUSTOM ####################
    var createDynamicCheckbox = function() {
        // Check if jQuery included
        if (typeof jQuery == 'undefined') {
            return;
        }
        ...
        var elements = [].slice.call(document.querySelectorAll('[data-control="dynamic-checkbox"]'));
        ...
        elements.map(function (element) {
            ...
            $('input',element).on('change', function() {
                let value = $('input',element).prop('checked')?1:0;
                $(`span[data-dynamic-checkbox-value=${value}]`,element).removeClass('d-none');
                $(`span[data-dynamic-checkbox-value!=${value}]`,element).addClass('d-none');
...
// #######################################
    ...
    return {
        ...
        createDateRangePickers: function() {
           createDateRangePickers();
        },
...
var KTMenu = function(element, options) {
    ...
    var _showDropdown = function(item) {
        ...
        $(the.element).trigger('kt.menu.dropdown.shown');
    }
    ...
    var _setActiveLink = function(link) {
        ...
        activeParentItems.map(function (activeParentItem) {
            if (activeParentItem.contains(item) === false) {
                ...
                if(!activeParentItem.classList.contains('menu-item-fixed'))
                {
